...
from robot_lab.sim import FixedRatioMultiAssetSpawnerCfg
...
UNITREE_GO2_GO2W_CFG = ArticulationCfg(
    spawn=FixedRatioMultiAssetSpawnerCfg(
        assets_cfg=[
            sim_utils.UrdfFileCfg(
                fix_base=False,
                merge_fixed_joints=True,
                replace_cylinders_with_capsules=False,
                asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/unitree/go2_description/urdf/go2_description_16dof.urdf",
                activate_contact_sensors=True,
                rigid_props=sim_utils.RigidBodyPropertiesCfg(
                    disable_gravity=False,
                    retain_accelerations=False,
...
"""Configuration for a mixed Go2/Go2W asset pool with 16-DOF control."""
