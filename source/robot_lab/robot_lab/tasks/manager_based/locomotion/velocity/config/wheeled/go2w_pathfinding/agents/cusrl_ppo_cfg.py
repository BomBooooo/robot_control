...
@dataclass
class UnitreeGo2WPathfindingRoughTrainerCfg(TrainerCfg):
...
@dataclass
class UnitreeGo2WPathfindingFlatTrainerCfg(UnitreeGo2WPathfindingRoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "unitree_go2w_pathfinding_flat"
